...
namespace Religion
{
    internal class WorkGiver_Worship : WorkGiver_Scanner
    {
        ...
        public override bool HasJobOnThing(Pawn pawn, Thing t, bool forced = false)
        {
            ...
            if (lectern.CompAssignableToPawn.AssignedPawnsForReading[0] == pawn &&
        ...
        {
            return new(ReligionDefOf.HoldWorship, t);
        }
    }
}
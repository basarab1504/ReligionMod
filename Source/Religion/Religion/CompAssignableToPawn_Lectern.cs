		...
		public override IEnumerable<Pawn> AssigningCandidates
		{
			get
			{
				...
				return parent.Map.mapPawns.FreeColonists.Where
					...
					&& !parent.Map.listerBuildings.allBuildingsColonist.Any(u => u is Building_Lectern && (u as Building_Lectern).CompAssignableToPawn.AssignedPawnsForReading.Contains(x)));

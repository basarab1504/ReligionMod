...
namespace Religion
{
    public class ThingWithComps_Book : ThingWithComps
    {
        ...
        {
            yield return new FloatMenuOption("TakeABook".Translate(), () => selPawn.jobs.TryTakeOrderedJob(new Job(JobDefOf.TakeInventory, this) { count = 1 }), MenuOptionPriority.Default, null, null, 0.0f, null, null);
            //if (first == null)

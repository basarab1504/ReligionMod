...
namespace Religion
{
    class ThingWithComps_Book : ThingWithComps
    {
        public override IEnumerable<FloatMenuOption> GetFloatMenuOptions(Pawn selPawn)
        {
            ...
            yield return new FloatMenuOption("ReadABook".Translate(), (Action)(() => selPawn.jobs.TryTakeOrderedJob(ReligionUtility.PlaceToRead(selPawn, this))), MenuOptionPriority.Default, (Action)null, (Thing)null, 0.0f, (Func<Rect, bool>)null, null);
        }
    }
}

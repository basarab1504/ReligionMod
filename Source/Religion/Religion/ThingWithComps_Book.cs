...
namespace Religion
{
    public class ThingWithComps_Book : ThingWithComps
    {
        ...
        {
            yield return new FloatMenuOption("TakeABook".Translate(), (Action)(() => selPawn.jobs.TryTakeOrderedJob(new Job(JobDefOf.TakeInventory, (LocalTargetInfo)this) { count = 1 })), MenuOptionPriority.Default, (Action)null, (Thing)null, 0.0f, (Func<Rect, bool>)null, null);
            //if (first == null)
